...
const App = () => {
  ...
  return(
    <>
    <Modal style={styles.Modal} transparent={true} animationType="slide" visible={modalVisibleplaya} onRequestClose={() =>{ alert('Modal has been closed');}}>
      <View style={styles.vistaModal}>
        <View sty={styles.Modal}>
          <Text style={styles.subtitulo}>Ir a la playa</Text>
          <Text style={styles.subtitulo}>El Salvador cuenta con hermosas playas a nivel Centroamérica</Text>
